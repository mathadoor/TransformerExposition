...
const text_x = baseline_x;
const text_y = baseline_y / 2;

// Token Info
const token_width = 13;
const token_height = 85;
const token_x = baseline_x - text_width / 2 - x_gap - token_width / 2;
const token_y = baseline_y;

// Position info
const position_width = 17;
const position_height = 40;
const position_x = baseline_x;
const position_y = baseline_y * 3 / 2;
