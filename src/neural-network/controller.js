...
function Controller(props){
  ...
  return (
    <svg ref={ref} id={id} style={{"filter": isBlurred ? "blur(5px)" : "none"}}>
      <svg fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => updateCounter(-1)} style={{ cursor: 'pointer' }}>
        <g transform={`translate(${x_rewind}, ${10}) scale(0.33 0.33)`} >
          <circle cx={width / 2} cy={height} r={width / 2.1} fill={mouseOver1 ? hoverfill: "transparent"} onMouseEnter={() => setMouseOver1(true)} onMouseLeave={() => setMouseOver1(false)}/>
          {/*SVG Downloaded from https://www.svgrepo.com/svg/529176/rewind-back-circle*/}
    ...
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => updateCounter(1)} style={{ cursor: 'pointer'}}>
      <g transform={`translate(${x_forward}, ${10}) scale(0.33 0.33)`} >
          <circle cx={width / 2} cy={height} r={width / 2.1} fill={mouseOver2 ? hoverfill: "transparent"} onMouseEnter={() => setMouseOver2(true)} onMouseLeave={() => setMouseOver2(false)}/>
        {/*SVG Downloaded from https://www.svgrepo.com/svg/529177/rewind-forward-circle*/}
  ...
  <svg fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => updateCounter(-50)} style={{ cursor: 'pointer' }}>
      <g transform={`translate(${x_reset}, ${10}) scale(0.33 0.33)`} >
          <circle cx={width / 2} cy={height} r={width / 2.1} fill={mouseOver3 ? hoverfill: "transparent"} onMouseEnter={() => setMouseOver3(true)} onMouseLeave={() => setMouseOver3(false)}/>
        {/*SVG Downloaded from https://www.svgrepo.com/svg/343263/reset*/}
